class User < ApplicationRecord
  ...
  validates :last_name_kana, presence: true, format: { with: /\A[ァ-ヶ一-]+\z/, message: 'は全角カタカナを使用してください' }
  validates :first_name_kana, presence: true, format: { with: /\A[ァ-ヶ一-]+\z/, message: 'は全角カタカナを使用してください' }
